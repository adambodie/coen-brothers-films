let films = [{
  ...
  "image": "blood-simple",
	...
	"review": "The Coen Brothers debut film came out in 1984, a tale of a bar owner Julian Marty (Dan Hedaya) who hires an investigator to hill his wife and lover, only to be double crossed by his own investigator.  While the plot of the film is rather mundane and typical, the Coen Brothers introduce some of their key elements into the film, mainly their dark humor and mood-capturing visual details, along with their well timed twists.  The characters in the movie aren't particularly deep and enchanting, but nonetheless move the story along.  In all, it's a good debut for the Coen Brothers, who manage to make a simple story more suspensful, and introduce us to many of their key film stylings that further evolved for years to come.",
	"stars": 3.5
  ...
  "image": "millers-crossing",
	...
	"review": "Miller's Crossing, released in 1990, is the Coen Brothers foray into the gangster film, with the plot revolving around gangster Tom Reagan (Gabriel Byrne), who finds himself working with and double crossing two rival gangs.  Miller's Crossing is the type of film that gracefully blows through the wind, a description clearly fitting through the references of a fedora flowing through a bed of leaves in a forest.  Like movies of its kind, Miller's Crossing is full of dramatic gangster elements, but yet the Coen Brothers make Miller's Crossing their own, using the visual feel for the film taking one back to the days of the Irish Mob of the Prohibition days to perfection.",
	"stars": 4.0
}, {
	"title": "Barton Fink",
  "image": "barton-fink",
	...
	"review": "Barton Fink, released in 1991, is about a playwrite named Barton Fink (John Turturro) who heads out the Los Angeles to write a B-Movie, only to get writer’s block and wind up involved in a murder investigation. More than any other of the Coen Brothers film, Barton Fink is full of symbolism and intrigue from the main character, whose quest for filming about the common man clashes with the modern Hollywood scene, in particular with the director Jack Lipnick (Michael Lerner), whose dynamic, hyper-energized role led to a nomination for best supporting actor.  Barton Fink is perhaps the Coen Brothers most complex and sympathetic character, whose frustrations and determination to reach for the common man provides a sense of gritty realism.  The plot is a bit dull at times, but fits with the rundown scenery in the film.  Barton Fink won’t blow your mind, but those seeking deeper meaning will enjoy this film.",
	"stars": 4.0
}, {
  ...
  "image": "ladykillers",
	...
	"review": "A remake of the 1955 British Ealing comedy film of the same name, The Ladykillers is about Ph.D Goldthwaite Higginson Dorr (Tom Hanks), who rents a room from a house of elderly widow Marva Munson (Irma Hall) to pull off a casino heist.  More of a modern version of the old classic, based in Mississippi, rather than London, The Ladykillers seems a bit odd at times.  Though Tom Hanks plays the main role quite well, he seems to be the only thing keeping the film from being a complete disaster, as the mix of characters and the overfall vibe of the film don't mix.  While it's not one of the better Coen Brothers films, it's still better than most of the garbage out these days, as Tom Hanks manages to keep the film at least somewhat interesting, especially in the beginning.",
	"stars": 3.0
